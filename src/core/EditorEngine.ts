...
import type { EditorState, ParagraphNode, EditorRange, TextFormat, EditorCommand } from '../types/editor.types.js';
...
export class EditorEngine {
  ...
  public updateSelection(range: EditorRange | null): void {
    this.state.selection = range;
    this.updateActiveFormat();
  }

  private updateActiveFormat(): void {
    ...
    let currentPos = 0;
    let activeFormat: TextFormat = this.getDefaultFormat();
  ...
  public deleteText(range?: EditorRange): void {
    this.saveToHistory();
  ...
  public applyFormat(format: Partial<TextFormat>, range?: EditorRange): void {
    this.saveToHistory();
  ...
  public getActiveFormat(): TextFormat {
