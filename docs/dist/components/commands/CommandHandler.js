...
export class CommandHandler {
    constructor(contentElement, onFormatUpdate) {
    ...
    handleTextFormatCommand(command) {
        const commandMap = {
            'bold': 'bold',
            'italic': 'italic',
            'underline': 'underline',
    ...
    handleFontCommand(command, value) {
    ...
    handleFontFamily(fontFamily, selection, hasSelection) {
