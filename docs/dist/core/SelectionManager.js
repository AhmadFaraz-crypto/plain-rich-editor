...
export class SelectionManager {
    constructor(containerElement, onSelectionChange) {
    ...
    getTextOffset(node, offset) {
        let totalOffset = 0;
        let found = false;
        const walker = document.createTreeWalker(this.containerElement, NodeFilter.SHOW_TEXT | NodeFilter.SHOW_ELEMENT, {
            acceptNode: (node) => {
